...
public interface UGraph<N extends UGraphComponent<E>, E extends UGraphComponent<N>> {
        ...
        /**
         * Removes a node from the graph. All adjacent edges should also be
         * removed.
         * 
         * @param node
         *                the node to remove.
         ...
         * graph with the same connected components but no cycles. If this graph
         * is connected, a spanning tree will be returned.
         * 
        ...
        /**
         * Gets a path in this graph from the given start node to the given end
         * node. If there is no path, {@code null} is returned.
         * 
